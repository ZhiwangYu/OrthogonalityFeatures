# -*- coding: utf-8 -*-
"""
本程序提供了拓扑卷积核在音素上的尝试，将传统神经网络和三个有一定拓扑特征的卷积核生成的神经网络进行对比，
得到传统神经网络对应的混淆矩阵和和对比图
"""
...
DATASET_PATH = 'data/speech_box/audio_segment_no012_selected'
    ...
    def build(self, input_shape):
        ...
        for theta_1 in thetas:
            for theta_2 in thetas:
                #偏离中心的球面
                w = 25/49*k2+24/49*(np.cos(theta_2)*(np.cos(theta_1/2+np.pi/16)*k2+np.sin(theta_1/2+np.pi/16)*v22)   #v2,v22可互换
